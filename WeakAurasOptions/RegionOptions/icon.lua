...
WeakAuras.RegisterRegionOptions("icon", createOptions, "Interface\\AddOns\\WeakAuras\\!Compatibility\\Icons\\Temp.blp", L["Icon"], createThumbnail, modifyThumbnail, L["Shows a spell icon with an optional a cooldown overlay"]);